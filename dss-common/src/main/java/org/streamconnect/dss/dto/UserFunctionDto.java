...
/**
 * The class User Function Dto
 *
 */
public class UserFunctionDto implements java.io.Serializable {
    ...
    /**
     * Gets date user function.
     *
     * @return the date user function
     */
    public Date getDateUf() {
        return dateUf;
    }

    /**
     * Sets date user function.
     *
     * @param dateUf the date user function
     */
    public void setDateUf(Date dateUf) {
        this.dateUf = dateUf;
    }
