...
/**
 * The type Cassandra persists.
 */
public class CassandraPersists implements java.io.Serializable {
    ...
    /** Cassandra data time to live. */
    private String timeToLive;

    /**
     * Instantiates a new Cassandra persists.
     */
    public CassandraPersists() {
        super();
    }
