...
/**
 * Kafka-Spark-Elassandra-Avro data pipeline Interpreter for Python is created
 * here
 *
 */

@Service
public class KafkaSparkELAvroInterpreter extends StreamFlowInterpreter {

    /** The logger. */
    private static final DSSLogger LOGGER = DSSLogger
            .getLogger(KafkaSparkELAvroInterpreter.class);

    /**
     * default constructor.
     */
    public KafkaSparkELAvroInterpreter() {
     ...
     *            the features
     */
    public KafkaSparkELAvroInterpreter(final String features) {
     ...
     *            the obj pipeline
     */
    public KafkaSparkELAvroInterpreter(final PipelineConfigDto objPipeline) {
    ...
    public boolean getPrerequisite(final PipelineConfigDto objPipelineConf) {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : getPrerequisite function : "
        ...
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in getPrerequisite function : ",
                    e);
    ...
    public boolean buildSource() {
        // TODO business logic
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : buildSource function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            bRet = true;
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in buildSource function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildEngine() {
        // TODO business logic
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : buildEngine function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            bRet = true;
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in buildEngine function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildProcess() {
        // TODO business logic
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : buildProcess function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            bRet = true;
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in buildProcess function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildSink() {
        // TODO business logic
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : buildSink function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            bRet = true;
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in buildSink function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public PipelineDetails getDataPipeline() {
        // TODO business logic
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELAvroInterpreter : getDataPipeline function : "
                + Constants.START_STATUS);
        ...
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELAvroInterpreter: in getDataPipeline function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
