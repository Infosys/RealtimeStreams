...
@Service
public class KafkaSparkELUnstructInterpreter extends StreamFlowInterpreter {

    /** The logger. */
    private static final DSSLogger LOGGER = DSSLogger
            .getLogger(KafkaSparkELUnstructInterpreter.class);

    /**
     * default constructor.
     */
    public KafkaSparkELUnstructInterpreter() {
     ...
     *            the features
     */
    public KafkaSparkELUnstructInterpreter(final String features) {
     ...
     *            the obj pipeline
     */
    public KafkaSparkELUnstructInterpreter(final PipelineConfigDto objPipeline) {
    ...
    public boolean getPrerequisite(final PipelineConfigDto objPipelineConf) {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : getPrerequisite function : "
        ...
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in getPrerequisite function : ",
                    e);
    ...
    public boolean buildSource() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : buildSource function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in buildSource function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildEngine() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : buildEngine function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ObjectMapper mapper = new ObjectMapper();
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in buildEngine function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildProcess() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : buildProcess function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in buildProcess function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean genProcessLogic() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : genProcessLogic function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in genProcessLogic function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    private String getUnstructSchema(final BusinessSqlDto objBSql) {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : getUnstructSchema function : "
                + Constants.START_STATUS);
        String strRet = "";
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in getUnstructSchema function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    private String getUnstructQry(final BusinessSqlDto objBSql, final String strTableName) {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : getUnstructQry function : "
                + Constants.START_STATUS);
        String strRet = "";
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in getUnstructQry function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean genParsingLogic() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : genParsingLogic function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        ...
        try {
            ...
            if (pipelineConf.getStrDataSchema().getStrSchemaType()
                    .equalsIgnoreCase("unstructured")) {
                strCode += "parsedStream = kafkaStream.map(lambda line : Row(line[1].encode('UTF8'),str(uuid.uuid4()),tval.strftime(\"%Y-%m-%d %H:%M:%S\", tval.localtime()), str(random.randint(1, 10))))\n";
              //lambda x: Row(x[1].encode('UTF8'),str(uuid.uuid4()),tval.strftime("%Y-%m-%d %H:%M:%S", tval.gmtime()), str(random.randint(1, 10)) )
            }
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in genParsingLogic function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean genIterativeLogic() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : genIterativeLogic function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            String strCode = "";
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in genIterativeLogic function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    private String createTableQryWithDefaultCols(final String strDBName,
        ...
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : createTableQryWithDefaultCols function : "
                + Constants.START_STATUS);
        String strRet = "";
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in createTableQryWithDefaultCols function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean buildSink() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : buildSink function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ObjectMapper mapper = new ObjectMapper();
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in buildSink function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public PipelineDetails getDataPipeline() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : getDataPipeline function : "
                + Constants.START_STATUS);
        ...
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in getDataPipeline function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    private String createTableQry(final String strDBName, final String strPersistTo,
        ...
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : createTableQry function : "
                + Constants.START_STATUS);
        String strRet = "";
        try {
            //String ttlValue = PropReader
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in createTableQry function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    private String createIndexQry(final String strDBName, final String strPersistTo,
        ...
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : createIndexQry function : "
                + Constants.START_STATUS);
        String strRet = "";
        try {
            strRet = "session_" + strPersistTo
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in createIndexQry function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
    ...
    public boolean genSinkTableLogic() {
        LOGGER.info(LogMessageEnum.ENGINE_LAYER_INFO.getMessage()
                + " KafkaSparkELUnstructInterpreter : genSinkTableLogic function : "
                + Constants.START_STATUS);
        boolean bRet = false;
        try {
            ...
            LOGGER.error(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getCode().toString()
                            ...
                            + ErrorMessageEnum.ENGINE_LAYER_EXCEPTION
                            .getMessage()
                            + "  KafkaSparkELUnstructInterpreter: in genSinkTableLogic function : ",
                    e);
            throw new InterpreterException(
                    ErrorMessageEnum.ENGINE_LAYER_EXCEPTION.getMessage() + " : "
                            + e.getMessage(),
