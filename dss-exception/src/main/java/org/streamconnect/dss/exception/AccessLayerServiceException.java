 ...
 * @version 1.0
 */
public class AccessLayerServiceException extends DSSException {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger
            .getLogger(AccessLayerServiceException.class);
     ...
     */
    public AccessLayerServiceException() {
    }
     ...
     *            the error code
     */
    public AccessLayerServiceException(final String message,
     ...
     *            the cause
     */
    public AccessLayerServiceException(final Throwable cause) {
        super(cause);
    }
