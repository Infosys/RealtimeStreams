...
/**
 * Exception class for Interpreter Layer for DSS Platform.
 *
 * @version 1.0
 */
public class InterpreterException extends DSSException {

    /** The Constant LOGGER. */
    private static final Logger LOGGER = Logger
            .getLogger(InterpreterException.class);
     ...
     *            the err code
     */
    public InterpreterException(final String message, final String errCode) {
