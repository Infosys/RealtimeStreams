...
import org.streamconnect.dss.access.api.response.SuccessVO;
import org.streamconnect.dss.logger.DSSLogger;
import org.streamconnect.dss.access.api.response.ErrorVO;
...
public abstract class BaseResponseBuilder {
     ...
     * @return String
     */
    protected final String getContentBuildingErrorMessage(final String message,
            final String code, final Exception e) {
        LOGGER.info("In BaseResponseBuilder: getContentBuildingErrorMessage("
                + "String message, String code, Exception e) ---> " + "Start");
        ...
        try {
            ...
            LOGGER.info(
                    "In BaseResponseBuilder: getContentBuildingErrorMessage("
                            + "String message, String code, Exception e) "
                            + "---> End");
        } catch (Exception e1) {
            LOGGER.error("Exception in BaseResponseBuilder: "
                    + "getContentBuildingErrorMessage function:", e1);
    ...
    protected String getNullPointerErrorMessage() {
        LOGGER.info("In BaseResponseBuilder: getNullPointerErrorMessage() "
                + "---> Start");
        ErrorVO error = new ErrorVO();
        ...
        try {
            ...
            LOGGER.error("Exception in BaseResponseBuilder: "
                    + "getNullPointerErrorMessage function:", e);
            return writeValueAsString;
        }
        return writeValueAsString;
    }
    ...
    protected <T> String toCollectionJsonify(final List<T> toJson) {
        ...
        try {
            ...
            LOGGER.error("Exception in BaseResponseBuilder: "
                    + "toCollectionJsonify  function:", e);
    ...
    protected String getContentBuildingSuccessMessage(final String message) {
        LOGGER.info("In BaseResponseBuilder: getContentBuildingSuccessMessage("
        ...
        try {
            writeValueAsString = objectMapper.writeValueAsString(list);
            LOGGER.info(
                    "In BaseResponseBuilder: getContentBuildingSuccessMessage("
                            + "String message)  ---> End");
        } catch (Exception e1) {
            LOGGER.error("Exception in BaseResponseBuilder: "
                    + "getContentBuildingSuccessMessage function:", e1);
            return writeValueAsString;
        }
        return writeValueAsString;
    }
    ...
    protected String getContentBuildingError(final String message,
            final String code) {
        LOGGER.info("In BaseResponseBuilder: getContentBuildingError("
                + "String message, String code)  ---> Start");
        ErrorVO error = new ErrorVO();
        error.setErrorCode(code);
        error.setErrorMessage(message);
        ...
        try {
            writeValueAsString = objectMapper.writeValueAsString(list);
            LOGGER.info("In BaseResponseBuilder: getContentBuildingError("
                    + "String message, String code)  ---> End");
        } catch (Exception e1) {
            LOGGER.error("Exception in BaseResponseBuilder: "
                    + "getContentBuildingError function:", e1);
            return writeValueAsString;
        }
        return writeValueAsString;
    }
