...
public class User {
    ...
    private String strDateRoleMapped;
    ...
    public String getStrDateRoleMapped() {
        return strDateRoleMapped;
    }

    /**
     * Sets the date on which role(s) being mapped.
     *
     * @param strDateRoleMapped
     *            the new date on which role(s) being mapped.
     */
    public void setStrDateRoleMapped(String strDateRoleMapped) {
        this.strDateRoleMapped = strDateRoleMapped;
    }
