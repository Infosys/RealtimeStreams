...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('flowchart/canvas.html',
    ...
    '    <path d="M0,0 V10 L5,5 Z" fill="#5c96bc"/>\n' +
    '  </marker>\n' +
    '	</defs>\n' +
    '    <g ng-repeat="edge in model.edges">\n' +
    '      <path\n' +
    '        marker-end="url(#head)" ng-click="edgeClick($event, edge)" \n' +
    ...
    '\n' +
    '      <path marker-end="url(#head)" class="{{ flowchartConstants.edgeClass }} {{ flowchartConstants.draggingClass }}"\n' +
    ...
    '      <path marker-end="url(#head)" d=""></path>\n' +
...
module.run(['$templateCache', function($templateCache) {
  $templateCache.put('flowchart/node.html',
    ...
    '  >\n' +
    '  <div class="innerNode">\n' +
    '		<div class="clickNode" ng-click="callbacks.doubleClick($event,node)" style="z-index:  1;cursor:  pointer;">\n' +
    '		<img src="{{ node.img }}" alt="icon" style="position:  absolute;left: 5px;top: 5px;pointer-events: none"></a>\n' +
    '    	<p>{{ node.name }}</p>\n'	+
    '		</div>\n' +
    '\n' +
    '    <div class="{{flowchartConstants.topConnectorClass}}" style="pointer-events: none;">\n' +
    '      <div fc-magnet\n' +
    ...
    '      </div>\n' +
    '    </div>\n' +
    '    <div class="{{flowchartConstants.bottomConnectorClass}}" style="pointer-events: none;">\n' +
    '      <div fc-magnet\n' +
